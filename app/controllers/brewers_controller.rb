class BrewersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to brewers_path, status: :see_other, notice: "Brewer was successfully destroyed." }
  ...
  private
    ...
    def set_brewer
      @brewer = Brewer.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def brewer_params
      params.expect(brewer: [ :name ])
    end
end
